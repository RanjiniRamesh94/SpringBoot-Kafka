...
import my.learning.kafka.KafkaSender;
import my.learning.model.Product;
import my.learning.service.ProductServiceImpl;
...
public class ProductController {
	...
	public String createProduct(@RequestBody Product request) {
		...
		// kafkaSender.send(request.getProductName() + " - Product Created
		// Successfully");

		kafkaSender.send(request);

		// kafkaTemplate.send("product-topics\",request.getProductName() + \" - Product
